        ...
        protected virtual void OnEnableInitializeSet()
        {
            ...
            if (PrefabUtility.GetPrefabType(baseTarget.gameObject) == PrefabType.Prefab)
            {
                ...
                if (go != null)
                {
                    ...
                    #region Children
                    {
                        var childrenVoxelBases = baseTarget.gameObject.GetComponentsInChildren<VoxelBase>(true);
                    ...
                    #region Extra
                    {
                        var childrenVoxelBaseExplosions = baseTarget.gameObject.GetComponentsInChildren<VoxelBaseExplosion>(true);
